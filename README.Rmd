...
The next step would be to load the data for the specific plan of interest. Let's use Texas Teacher Retirement System as an example. Let's first see what plans in Texas are available with the word "teacher' in the name:
...
The full plan name we are interested in is there listed as "Texas Teacher Retirement System". We can pull the data for it now:
